...
Is the name to identified the collection that represent a grouping of data.
...
(if any) delimited by ?????. Command names are lower-case and are case-sensitive.
...
# add [collection-key] [parameters]
	...
	# example
	add collection1 "1234567890" 1 "jaz"
	OK
...
=head3 get [collection-key] [enum|ts] 
	...
	# example
	get collection bar:jaz ts:1234567880-1234567890
	OK 1
